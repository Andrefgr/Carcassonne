...
public class Tile_CFFC_NC extends Tile {
	...
	public static Tile_CFFC_NC[] getPecas() {
		return new Tile_CFFC_NC[] { new Tile_CFFC_NC(), new Tile_CFFC_NC() };
	}
	private static String FILEPATH = "Tile14_cffc_nc_x2.jpg";
