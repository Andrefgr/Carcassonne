...
public class Tile_CCFC extends Tile {
...
//	private TileCharacteristics tileCharacteristics[] = new TileCharacteristics[4];
	...
	public static Tile_CCFC[] getPecas() {
		return new Tile_CCFC[] { new Tile_CCFC(), new Tile_CCFC(), new Tile_CCFC() };
	}
	...
	private static String FILEPATH = "Tile04_ccfc_x3.jpg";
