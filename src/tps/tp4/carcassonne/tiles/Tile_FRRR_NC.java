...
public class Tile_FRRR_NC extends Tile {
	...
	public static Tile_FRRR_NC[] getPecas() {
		return new Tile_FRRR_NC[] { new Tile_FRRR_NC(), new Tile_FRRR_NC(), new Tile_FRRR_NC(), new Tile_FRRR_NC() };
	}

	private static String FILEPATH = "Tile23_frrr_nc_x4.jpg";
