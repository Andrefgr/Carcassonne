...
public class Tile_FFFF_I extends Tile {
	...
	public static Tile_FFFF_I[] getPecas() {
		return new Tile_FFFF_I[] { new Tile_FFFF_I(), new Tile_FFFF_I(), new Tile_FFFF_I(), new Tile_FFFF_I() };
	}
	...
	private static String FILEPATH = "Tile01_ffff_i_x4.jpg";
