...
public class Tile_CRRC extends Tile {
	...
	public static Tile_CRRC[] getPecas() {
		return new Tile_CRRC[] { new Tile_CRRC(), new Tile_CRRC(), new Tile_CRRC() };
	}

	private static String FILEPATH = "Tile10_crrc_x3.jpg";
	...
	public boolean checkTileCharacteristics(TileCharacteristics characteristics) {
		if (characteristics.equals(TileCharacteristics.Castle))
			return true;
	...
	public int getNumCharacteristics(TileCharacteristics characteristics) {
		if (characteristics.equals(TileCharacteristics.Castle))
			return 2;
		else if (characteristics.equals(TileCharacteristics.Road))
			return 2;
		return 0;
	}
	@Override
