...
public class Tile_CFFC extends Tile {
	private static final long serialVersionUID = 1L;
	private static String FILEPATH = "Tile08_cffc_x3.jpg";
	...
	public static Tile_CFFC[] getPecas() {
		return new Tile_CFFC[] { new Tile_CFFC(), new Tile_CFFC(), new Tile_CFFC() };
	}
