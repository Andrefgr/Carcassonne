...
public class Tile_CRRF extends Tile {
	...
	public static Tile_CRRF[] getPecas() {
		return new Tile_CRRF[] { new Tile_CRRF(), new Tile_CRRF(), new Tile_CRRF() };
	}

	private static String FILEPATH = "Tile18_crrf_x3.jpg";
